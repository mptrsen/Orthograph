h1. ORTHOGRAPH: Orthology prediction using a Graph-based, Reciprocal Approach with
...
h2. 1. Set up the MySQL database. 
...
h2. 3. Upload your ortholog set into the database:
...
h2. 4. Load proteome sequences into the database :
...
h2. 4a. Optional: Load nucleotide data into the database:
...
h2. 7. Create the required database structure for Orthograph. Make orthograph executable
...
h2. 9. Get some coffee and watch.
...
h2. 10. Examine results in the output directory.
