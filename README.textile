...
into them. Google "mysql create database" or ask your administrator if you don't
know how to create the database. Make a note of your database name. You will
need it later.

h2. 2. Create the tables. Make the orthograph_manager script executable and use it:
